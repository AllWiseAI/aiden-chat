...
function AgentEditDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="flex flex-col items-center max-h-[max(80vh,648px)] px-0"
        ...
        {newAgent.source !== "default" ? (
          <>
            ...
            <div className="flex-1 flex flex-col gap-4 w-full text-sm font-normal scroll-container pl-6 pr-4">
              ...
              <div className="flex flex-col gap-1.5">
                <Label htmlFor="prompt" className="text-[#6C7275] w-max">
                  Prompt
                </Label>
                <Textarea
                  className="bg-white dark:bg-[#101213] placeholder:text-[#6C7275]/50 dark:placeholder:text-[#E8ECEF]/50 rounded-sm p-2.5 resize-none border border-white dark:border-[#101213] focus:border-[#00AB66] dark:focus:border-[#00AB66] hover:border-[#232627]/50 dark:hover:border-white overflow-y-auto max-h-[40vh]"
              ...
              <div className="flex flex-col gap-1.5">
                <Label
                  htmlFor="model"
                  className="text-[#6C7275] w-max after:content-['*'] after:text-red-500"
                >
                  Model
                </Label>
                <Select
