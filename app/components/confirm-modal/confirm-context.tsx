  ...
  const renderDescription = useCallback(() => {
    ...
    return (
      <AlertDialogDescription asChild>
        <div className="max-w-[278px] w-full flex flex-col items-center gap-2.5 text-base font-normal text-[#141718] dark:text-white border border-[#E8ECEF] dark:border-[#232627] rounded-sm px-2.5 py-2 whitespace-nowrap">
